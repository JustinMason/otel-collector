module github.com/justinmason/otel-collector/receiver/jsonlogreceiver
...
replace github.com/justinmason/otel-collector/receiver/jsonlogreceiver => ../../receiver/jsonlogreceiver

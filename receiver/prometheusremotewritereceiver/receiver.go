...
package prometheusremotewritereceiver // import "github.com/justinmason/otel-collector/receiver/prometheusremotewritereceiver"
...
func newRemoteWriteReceiver(set *receiver.Settings, cfg *Config, next consumer.Metrics) (*remoteWriteReceiver, error) {
